...
// (Phase 1: still mock; Phases 2–4 replace these with Supabase queries.)
...
export const F2F_CONVERSATIONS = [
  {
...
export const F2F_BANNED = ['weirdo', 'idiot', 'stupid', 'hate', 'nsfw'];
