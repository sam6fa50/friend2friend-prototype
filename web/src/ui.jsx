...
export const TOP_SAFE = 60;   // clears status bar + dynamic island
export const BOT_SAFE = 30;   // clears home indicator

// aliases kept for parity with the prototype's window.F2F_* names
export const F2F_GREEN = GREEN;
export const F2F_INK = INK;
export const F2F_BG = BG;
export const F2F_TOP_SAFE = TOP_SAFE;
export const F2F_BOT_SAFE = BOT_SAFE;

// ── Icons (lucide-style, stroke) ──────────────────────────────────────────
export function Icon({ name, size = 24, stroke = 'currentColor', fill = 'none', sw = 2, style }) {
...
export function Avatar({ initials, size = 56, dim = false }) {
  return (
    <div style={{
...
// ── Interest pill ──────────────────────────────────────────────────────────
export function Pill({ children, on = true, onRemove, onClick, small = false }) {
  return (
...
export function MapPlaceholder({ height = 130, label = 'Irvine, CA', radius = false }) {
  return (
    <div style={{
...
export function SocialIcon({ kind, on }) {
  const wraps = {
...
export function ScreenHeader({ title, right, sub }) {
  return (
...
// ── Toast ──────────────────────────────────────────────────────────────────
export function Toast({ children, accent }) {
  return (
    <div style={{
